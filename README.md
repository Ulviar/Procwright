...
session scenario, and the first line-oriented request/response workflow. The public API and runtime are still
incomplete: documentation must not promise behavior before tests and implementation prove it.
