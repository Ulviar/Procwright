...
public final class LineSessionOptions {
    ...
    private static final LineSessionOptions DEFAULTS = new LineSessionOptions(
            Duration.ofSeconds(5), 64 * 1024, 1024, StandardCharsets.UTF_8, ResponseDecoder.firstLine());
    ...
    public LineSessionOptions withRequestTimeout(Duration requestTimeout) {
        return new LineSessionOptions(requestTimeout, transcriptLimit, stdoutBacklogLimit, charset, responseDecoder);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(requestTimeout, transcriptLimit, stdoutBacklogLimit, charset, responseDecoder);
    }
