...
final class PooledLineSessionInvocationDefaultsTest {
    ...
    void appliesAllServiceLevelPoolDefaultsBeforeUserOverrides() {
        Consumer<io.github.ulviar.procwright.session.LineSession> reset = worker -> {};
        Predicate<io.github.ulviar.procwright.session.LineSession> healthCheck = worker -> true;
