...
final class ProtocolSessionIntegrationTest {
    ...
    private static CommandService fixtureService(
        ...
        return new CommandService(
                ...
                io.github.ulviar.icli.session.LineSessionOptions.defaults(),
                io.github.ulviar.icli.session.StreamOptions.defaults(),
                io.github.ulviar.icli.session.PooledLineSessionOptions.defaults(),
                protocolOptions,
