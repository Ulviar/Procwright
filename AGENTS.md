...
- Pooling, MCP, samples и benchmarks не входят в первый MVP; optional Kotlin module входит как тонкий adapter без
  зависимости Java core от Kotlin runtime/coroutines.
