...
| Public package surface does not leak internal or external process-library types. | JPMS descriptors, `PublicApiSurfaceTest`, `PublicIntegrationApiSurfaceTest`, external boundary check. | `PackageBoundaryTest`, `PublicApiSurfaceTest`, `ExternalLibraryBoundaryTest`, `externalLibraryBoundaryCheck`. |
