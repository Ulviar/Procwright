...
публичные package boundaries по всему production artifact; session shutdown escalation hardening остается отдельным
release gate до тестового закрытия или явного release limitation.
