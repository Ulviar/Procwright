...
Этот документ задает обязательные требования ко всему проекту Procwright. Если возникает конфликт между скоростью
и качеством, выбирается качество.

## Главный стандарт

Procwright должен разрабатываться без спешки, без экономии на проектировании, тестах, документации и API. Цель — не быстро
...
Максимальная версия Procwright должна вырасти из маленького надежного ядра, а не из набора поспешных компромиссов.
