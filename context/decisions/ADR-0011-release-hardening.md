...
- Java baseline — JDK 25, production bytecode компилируется с `--release 25`;
- публичные пакеты стабилизируются на уровне `com.github.ulviar.icli`,
  `com.github.ulviar.icli.kotlin` и `com.github.ulviar.icli.integration`;
