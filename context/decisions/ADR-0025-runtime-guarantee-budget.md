...
Библиотека ещё не выпущена, поэтому machine-readable `0.1.0` baseline является инструментом review, а не обещанием
совместимости пользователям. Он не должен блокировать осознанное удаление лишней поверхности.
...
- custom exact compatibility checker удаляется, если его единственная функция — сравнение с ещё не выпущенной версией;
...
- ADR-0016 теряет преждевременную signature freeze вместе с удалением compatibility checker;
