...
iCLI должен сохранять один scenario-first API и один набор инвариантов на поддерживаемых JVM targets. Нужен один source
...
Gradle property `icli.javaRelease` выбирает target release. Значение по умолчанию — `25`; published artifacts используют
