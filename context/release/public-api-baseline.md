...
Этот документ фиксирует intended public surface для baseline `0.1.0`. Источник правды для точного списка public types
находится в тестах, чтобы любое случайное расширение API ломало обычный verification gate.
