...
- Delivery listener и transcript sink выполняется асинхронно best-effort.
...
- `run`, `interactive`, `lineSession`, `listen` и worker launches внутри `pooled` испускают lifecycle events.
